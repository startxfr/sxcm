...
function myDemoInfo {
    cat <<EOF
Description : Deployment of a KUSTOMIZE sample application using this infrastructure to 
              demonstrate the gitops capacities of KUSTOMIZE solution integrated with an 
