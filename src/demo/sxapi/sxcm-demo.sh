...
function myDemoInfo {
    cat <<EOF
Description : Deployment of a SXAPI sample application using various deployment models to 
              demonstrate the simplicity, easy to use and codeless capacities of SXAPI solution 
              integrated with an openshift 4 environment
Require     : none
EOF
}
