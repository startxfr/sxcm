...
function myDemoInfo {
    cat <<EOF
Description : Deployment of multiple samples applications using OCP Helm support to 
              demonstrate how to use helm chart to paackage and deploy applications under an
