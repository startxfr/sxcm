...
function myDemoInfo {
    cat <<EOF
Description : Deployment of a ARGOCD sample application using this infrastructure to 
              demonstrate the gitops capacities of ARGOCD solution integrated with an 
