...
then
    ...
    oc adm policy remove-scc-from-user privileged system:serviceaccount:$PROJECT:freeipa-pod
    oc adm policy remove-scc-from-user anyuid system:serviceaccount:$PROJECT:freeipa-pod
else 
